# Приложение для учета оборудования на складах
...
Доступ (на чтение) к которым имеет зарегистрированный пользователь. Доступ на изменение имеет администратор.
  - http://127.0.0.1:8000/api/v1/stock/ - посмотреть все возможные склады методом GET
  - http://127.0.0.1:8000/api/v1/category/ - категории оборудования 
  - http://127.0.0.1:8000/api/v1/equipment/ - единицы оборудования
  - http://127.0.0.1:8000/auth/login/ - аутентификация по сессиям
